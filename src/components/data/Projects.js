      ...
      subProjects: [
        {
          ...
          description: "The management phase of the construction of Major Bridge No. 259 centers on effective project planning, resource allocation, and execution strategies. This includes the coordination of various teams across engineering, logistics, and safety sectors to minimize any disruptions to train services and ensure compliance with South Eastern Railway’s stringent safety standards. The project management team will focus on developing a detailed timeline, overseeing procurement of materials, and conducting regular inspections throughout the construction process.",
          image: (ongoing2),
        },
        {
          id: 102,
          title: "Multispan Major Bridge No. 259 Construction",
          description: "The construction of Multispan Major Bridge No. 259 involves the installation of a robust 12x45.7m open web girder bridge designed to accommodate 25-ton loading. Located at Nidhipanda on the railway section between Haldipada and Balasore, this project aims to enhance connectivity and support efficient rail transport. The project is developed under the auspices of South Eastern Railway / Garden Reach, ensuring adherence to safety and engineering standards throughout the construction process.",
          image: (ongoing3),
        },
        {
          id: 103,
  ...
  completed: [
    {
      ...
      subtitle: "Enhancing Transportation Facilities through Comprehensive Construction Projects",
      description: "The infrastructure development project at Sikaripara Station focuses on the construction of essential facilities including a new platform, an upgraded station building, and a secure boundary wall. These enhancements aim to improve passenger experience, ensure safety, and boost accessibility for the local community. Through these developments, Sikaripara Station will be better equipped to handle increasing passenger flow and provide a welcoming environment for travelers.",
      image: (completedA1),
      ...
      subProjects: [
        {
          ...
          description: "It includes the landscaping of the surrounding area of Barapalasi Station to improve aesthetics and functionality. It will feature greenspaces, parking areas, and pathways for easy access to the station. The aim is to create a welcoming environment for passengers and visitors alike.",
          image: (completedB2),
          progress: "4/4",
        },
      ],
    ...
    {
      id: 4,
      title: "Rehabilitation Work for Doubling of Andul - Baltikuri Section at Mourigram - Bankra Nayabaz Station",
      subtitle: "Enhancing Rail Infrastructure to Improve Capacity and Reliability",
      description: "This project focuses on the rehabilitation work at Mourigram - Bankra Nayabaz Station as part of the overarching initiative to double the Andul - Baltikuri railway section. The objective is to upgrade the existing infrastructure to accommodate increased train traffic, enhance operational safety, and improve passenger services. This project will utilize modern techniques and materials to ensure longevity and sustainability, thereby contributing to the efficiency of the railway network in the region.",
      image: (completedD1),
      tags: ["South Eastern Railway", "Garden Reach", "Infrastructure Development"],
      progress: "31/08",
      year: "2019",
      status: "Completed",
      subProjects: [
        {
          ...
          description: "It involves the realignment of existing tracks to improve the geometry and strengthen the trackbed to handle heavier loads and increased traffic. It includes replacing outdated ballast and ties, installing modern signaling systems, and ensuring compliance with safety standards.",
          image: (completedD2),
          progress: "4/4",
        },
        {
          ...
          description: "Enhancing the platforms and station facilities to provide better services to passengers is a key focus. This includes widening platforms, adding shelter, improving accessibility features, and upgrading lighting and signage to ensure a safe and comfortable experience for travelers.",
          image: (completedD3),
          progress: "5/5",
        },
        {
          ...
          description: "To enhance the drainage systems around the station to prevent flooding and manage stormwater effectively. It includes the installation of sustainable drainage solutions and measures to mitigate environmental impact during and after construction, promoting ecological balance in the region.",
          image: (completedD4),
          progress: "5/5",
        },
      ],
      ...
      subProjects: [
        {
          ...
          description: "It focuses on the comprehensive engineering design and planning of the road over bridge, ensuring it meets safety standards and structural integrity requirements. All design elements will consider load capacities, environmental impacts, and local regulations to create an efficient and reliable bridge.",
          image: (completedE2),
          progress: "4/4",
        },
        {
          ...
          description: "The construction phase of the project entails the procurement of high-quality materials, equipment, and skilled labor necessary for the effective execution of the road over bridge. This sub-project will detail the processes of site preparation, foundation work, span construction, and final finishing processes, ensuring adherence to timelines and budget constraints.",
          image: (completedE3),
          progress: "5/5",
        },
        {
      ...
      subProjects: [
        {
          ...
          description: "It focuses on the initial groundwork necessary for the ROB, including land clearing, excavation, and the setup of foundations to support the Bowstring Girder. Proper soil testing and stabilization will be conducted to ensure long-term durability and safety.",
          image: (completedG2),
          progress: "4/4",
        },
        {
          ...
          description: "Dedicated to the engineering and fabrication of the Bowstring Girder, this subproject includes the design specifications, material selection, and manufacturing processes. Quality control measures will be implemented to guarantee that the girders meet all structural integrity standards.",
          image: (completedG3),
          progress: "5/5",
        },
        {
          ...
          description: "This phase involves the transportation and installation of the Bowstring Girder onto the pre-built foundations. This subproject encompasses the use of cranes, safety protocols, and alignment checks to ensure the precise placement of the girder.",
          image: (completedG4),
          progress: "5/5",
        },
        {
          ...
          description: "Following the erection of the girder, this subproject will focus on constructing the bridge deck and integrating it with the existing roadways. It includes laying down the surface materials, drainage systems, and completing necessary road signage and markings.",
          image: (completedG5),
          progress: "5/5",
        }, {
          id: 705,
          title: "Safety Features and Environmental Management",
          description: "It is dedicated to implementing safety features such as guardrails, warning signals, and pedestrian crossings, ensuring the well-being of users. Additionally, it encompasses environmental management practices to mitigate the project's impact on the surrounding ecosystem during and after construction.",
          image: (completedG6),
          progress: "5/5",
        },
      ],
      ...
      subProjects: [
        {
          ...
          description: "It focuses on the construction of the bridge's substructure, including footings, piers, and abutments, ensuring a stable foundation for the composite girders. The work will comply with engineering standards and environmental regulations to support the bridge's structural integrity and longevity.",
          image: (completedH2),
          progress: "4/4",
        },
      ],
