...
export const PinPerspective = ({
  ...
  return (
    (<motion.div
      className="pointer-events-none  w-96 h-80 sm:h-60 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500  sm:mb-4">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            ...
            <span
              className="relative z-20 text-blue-200 text-xl font-extrabold inline-block py-0.5">
              {title}
            </span>
